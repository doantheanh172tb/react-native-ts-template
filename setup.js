...
const updatePackageJson = fileName => {
  try {
    ...
    packageJson.scripts.codepush_release =
      "appcenter codepush release-react -a doantheanh172tb/MyApp";
    packageJson.scripts.codepush_add_staging = `appcenter codepush deployment add -a doantheanh172tb/${name}-iOS Staging`;
    ...
    packageJson.scripts.codepush_list_deployment = `appcenter codepush deployment list -a doantheanh172tb/${name} -k`;
